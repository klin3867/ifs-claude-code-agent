"""
prompt_loader.py - Simple template resolver for ifs-prompts/
...
Usage:
    loader = PromptLoader("../ifs-prompts", {"VAR": "value"})
    prompt = loader.load("system-prompt-main-system-prompt-ifs.md")
"""
...
class PromptLoader:
    """Load and resolve prompt templates from ifs-prompts/ directory."""
    ...
    def __init__(self, prompts_dir: str, variables: Optional[dict] = None):
        ...
        Args:
            prompts_dir: Path to ifs-prompts/ directory
...
if __name__ == "__main__":
    ...
    loader = PromptLoader("../ifs-prompts")
